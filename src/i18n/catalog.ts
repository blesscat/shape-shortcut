export const zhHantMessages = {
  'models.model.opengrid-openconnect-tissue-box.name':
    'OpenGrid OpenConnect 面紙盒',
  'models.model.opengrid-openconnect-tissue-box.selection':
    'OpenConnect 面紙盒',
  'models.model.opengrid-openconnect-tissue-box.description':
    '頂部開放、底部抽取，內尺寸 XYZ、向上傾斜、外圓角與省料模式可調。',
  'models.model.opengrid-openconnect-tissue-box.alt':
    'OpenGrid 向上傾斜的 OpenConnect 掛牆面紙盒',
  'panel.tissueBox.help':
    '內尺寸：X 沿牆左右、Y 向外、Z 為盒內高度，皆沿盒身量測。面紙包倒放，由頂部補充、底部封閉長槽抽取。預覽與匯出皆讓抽取底面平貼列印平台（Z=0）；掛牆安裝後正角度抬高前端，接口保持直立。背板上下端與盒頂、盒底齊平；若高度不足以容納一列完整接口，請增加 Z 內高。R 只作用於遠離牆面的兩個前角，前方內角隨壁厚配合，圓角會占用角落空間；靠牆兩角為直角，與等寬後方支撐銜接。長槽沿 X，長度至少比寬度多 2 mm，距盒內邊緣至少 5 mm。省料只鏤空前面與兩側，上限 3000 格。預設尺寸僅為示例，可依面紙包調整。',
  ...
  'parameter.tissueBox.tiltAngle': '向上傾斜角',
  'parameter.tissueBox.outerRadius': '外圓角',
  'parameter.tissueBox.wallThickness': '壁厚',
  'parameter.tissueBox.bottomThickness': '底厚',
  'parameter.tissueBox.slotLength': '抽取槽長度',
  'parameter.tissueBox.slotWidth': '抽取槽寬度',
  ...
  'parameter.organizerHoleWidth': '孔寬（X）',
  'parameter.organizerHoleHeight': '孔高（Y）',
  'parameter.organizerHoleCornerRadius': '孔圓角半徑',
  ...
  'panel.box.topRim': '上緣',
  'panel.box.topRimStacking': '堆疊',
  'panel.box.topRimStackingDescription': '頂部建立堆疊上緣，可承接上方方盒。',
  'panel.box.topRimFlat': '平頂',
  'panel.box.topRimFlatDescription': '不建立堆疊上緣，頂部齊平。',
  'panel.box.bottom': '盒底',
  'panel.box.bottomStacking': '堆疊',
  'panel.box.bottomStackingDescription': '底部建立滑入結構，可疊於下方方盒上。',
  'panel.box.bottomThinShell': '薄殼',
  'panel.box.bottomThinShellDescription':
    '標準壁厚搭配 2 mm 薄底，無法疊於下方方盒上。',
  'panel.box.bottomNone': '無',
  'panel.box.bottomNoneDescription': '整個底部掏空，僅保留四角定位柱空間。',
  ...
  'panel.organizerBox.shape.rectangle': '長方形',
  'panel.organizerBox.shape.ellipse': '橢圓形',
...
export const enMessages: { [Key in keyof typeof zhHantMessages]: string } = {
  ...
  'parameter.tissueBox.tiltAngle': 'Upward tilt',
  'parameter.tissueBox.outerRadius': 'Outer corner radius',
  'parameter.tissueBox.wallThickness': 'Wall thickness',
  'parameter.tissueBox.bottomThickness': 'Bottom thickness',
  'parameter.tissueBox.slotLength': 'Dispensing slot length',
  'parameter.tissueBox.slotWidth': 'Dispensing slot width',
  ...
  'parameter.topRimHeight': 'Accent rim height',
  'panel.topRim': 'Two-color accent rim',
  ...
  'parameter.organizerHoleWidth': 'Hole width (X)',
  'parameter.organizerHoleHeight': 'Hole height (Y)',
  'parameter.organizerHoleCornerRadius': 'Hole corner radius',
  ...
  'panel.box.topRim': 'Top rim',
  'panel.box.topRimStacking': 'Stacking rail',
  'panel.box.topRimStackingDescription':
    'Builds the stacking rail on top so another box can stack above.',
  'panel.box.topRimFlat': 'Flat top',
  'panel.box.topRimFlatDescription': 'No stacking rail; the top stays flush.',
  'panel.box.bottom': 'Box bottom',
  'panel.box.bottomStacking': 'Stacking',
  'panel.box.bottomStackingDescription':
    'Builds the slide-fit bottom so the box can stack onto the box below.',
  'panel.box.bottomThinShell': 'Thin-shell',
  'panel.box.bottomThinShellDescription':
    'Standard walls with a 2 mm thin floor; cannot stack onto the box below.',
  'panel.box.bottomNone': 'None',
  'panel.box.bottomNoneDescription':
    'The entire bottom is open; only the four corner locating spaces remain.',
  ...
  'panel.organizerBox.shape.rectangle': 'Rectangle',
  'panel.organizerBox.shape.ellipse': 'Ellipse',
