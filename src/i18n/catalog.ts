export const zhHantMessages = {
  ...
  'models.model.opengrid-label-card.description':
    '每格 10 mm 的可抽換雙色標籤卡，搭配壁掛收納方格正面卡槽；可選齊平或凸起樣式、圖示與文字。文字高度可調 4–7 mm，圖標可選無、左側或右側。',
  ...
  'panel.labelCard.details':
    '每格 10 mm 的可替換標籤卡，搭配壁掛收納方格正面卡槽使用。可選齊平或凸起樣式、圖示與文字；文字高度可調 4–7 mm，圖標可選無、左側或右側。雙色效果僅適用 3MF。',
...
export const enMessages: { [Key in keyof typeof zhHantMessages]: string } = {
  ...
  'models.model.opengrid-label-card.description':
    'A swappable two-color card in 10 mm units for the organizer front slot, with flat or raised styling, an icon, and optional text. Text height is adjustable from 4–7 mm, with an optional icon on either side.',
  ...
  'panel.labelCard.details':
    'A replaceable card sized in 10 mm units for the organizer front slot. Choose flat or raised styling, an icon, and optional text. Text height is adjustable from 4–7 mm, with an optional icon on either side. Two-color printing uses 3MF.',
