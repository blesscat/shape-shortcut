...
const OPENGRID_ORGANIZER_BOX_PARAMETER_SCHEMA: ReadonlyArray<ParameterField> = [
  ...
  },
  {
    ...
    unit: 'mm',
    control: 'range-text',
    defaultValue: OPENGRID_ORGANIZER_BOX_CONFIGURATION.defaultHoleWidth,
    min: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleWidth,
    max: OPENGRID_ORGANIZER_BOX_CONFIGURATION.maxHoleWidth,
    step: 0.5,
    sliderMin: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleWidth,
    sliderMax: 100,
  },
  {
    key: 'holeHeight',
    ...
    unit: 'mm',
    control: 'range-text',
    defaultValue: OPENGRID_ORGANIZER_BOX_CONFIGURATION.defaultHoleHeight,
    min: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleHeight,
    max: OPENGRID_ORGANIZER_BOX_CONFIGURATION.maxHoleHeight,
    step: 0.5,
    sliderMin: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleHeight,
    sliderMax: 100,
  },
  {
    ...
    unit: 'mm',
    control: 'range-text',
    defaultValue: OPENGRID_ORGANIZER_BOX_CONFIGURATION.defaultHoleCornerRadius,
    min: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleCornerRadius,
    max: OPENGRID_ORGANIZER_BOX_CONFIGURATION.maxHoleDiameter / 2,
    step: 0.5,
    sliderMin: OPENGRID_ORGANIZER_BOX_CONFIGURATION.minHoleCornerRadius,
    sliderMax: 50,
  },
  {
    key: 'holeDepth',
