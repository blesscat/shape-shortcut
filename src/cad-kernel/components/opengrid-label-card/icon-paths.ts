...
> = {
  ...
  // Drive icons are solid screw heads with the drive recess cut out; every
  // accent feature stays >= 2.3 viewport units (~0.86 mm at the 6 mm size).
  'drive-slot': {
    id: 'drive-slot',
    evenOdd: true,
    paths: ['M8 1 A7 7 0 1 0 8 15 A7 7 0 1 0 8 1 Z M2 6.7 H14 V9.3 H2 Z'],
  },
  'drive-phillips': {
    id: 'drive-phillips',
    evenOdd: true,
    paths: [
      'M8 1 A7 7 0 1 0 8 15 A7 7 0 1 0 8 1 Z M6.5 3.25 H9.5 V6.5 H12.75 V9.5 H9.5 V12.75 H6.5 V9.5 H3.25 V6.5 H6.5 Z',
    ],
  },
  'drive-hex': {
    id: 'drive-hex',
    evenOdd: true,
    paths: [
      'M8 1 A7 7 0 1 0 8 15 A7 7 0 1 0 8 1 Z M12 8 L10 11.464 L6 11.464 L4 8 L6 4.536 L10 4.536 Z',
    ],
  },
  'drive-torx': {
    id: 'drive-torx',
