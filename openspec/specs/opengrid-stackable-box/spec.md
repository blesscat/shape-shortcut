...
- **AND** the bottom guide MUST use a 0.8 mm bed-facing 45° foot, a 1.8 mm vertical segment, and an internal seam slot that flares at 45° from an 8.4 mm bed mouth to the 6.4 mm bed width over 1.0 mm of height and then tapers at 19° from the 6.4 mm bed width to a 4.5 mm opening at the floor underside without a horizontal closure land
...
#### Scenario: Seam relief mouth flare guides a spanning drop

- **WHEN** a multi-cell `stacking-rail` + `stacking` box is generated with `bottomMode='stacking'`
- **THEN** each internal cell-seam relief MUST measure an 8.4 mm opening at the bed-facing plane and reach the 6.4 mm bed width through a 1.0 mm 45° flare with no vertical wall band between the flare and the 19° taper
- **AND** the 19° taper and the 4.5 mm floor-underside opening MUST remain unchanged above the flare
- **AND** a 1×1 box MUST remain generated without any internal seam relief
